...
public class SoundClip {
	 ...
	 * @param _repeat es un <code>entero</code> que es 
	 ...
	 * @return repeat es un valor <code>entero</code> con el 
	 ...
	 * @param audiofile es un <code>String</code> 
         * con el nombre del archivo de sonido.
	 */
